...
<body class="bg-gray-100 flex">
    ...
    <aside id="sidebar" class="w-64 min-h-screen bg-white border-r border-gray-200">
        <a href="/dashboard-finance" class="flex items-center justify-center h-16 border-b border-gray-200">
        ...
        <nav class="px-2 space-y-2">
            <a href="{{ route('listSalary') }}"
                ...
                </span>Data Pengajuan Gaji
            </a>
            <a href="{{ route('Finance.listPayment') }}"
                class="flex items-center px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100">
                <span class="mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
